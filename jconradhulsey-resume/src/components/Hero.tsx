        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg md:text-xl mb-8 max-w-md text-gray-200">
              A cloud software engineer passionate about creating simple, yet robust digital solutions with attention to detail.
              Check out my LinkedIn profile for my professional experience or Github for my personal projects.
            </p>
