      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-2xl mx-auto">
          <form className="space-y-6">
            ...
            <button 
              type="submit" 
              className="px-8 py-3 bg-primary text-secondary font-medium rounded-lg hover:bg-opacity-90 transition-all"
            >
              Send Message
            </button>
          </form>
          ...
          <div className="mt-12 flex justify-center space-x-6">
            <a href="#" className="text-white opacity-80 hover:text-primary transition-colors">
