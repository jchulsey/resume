      ...
      <div className="container mx-auto">
        <div className="mb-16">
          ...
          <p className="text-gray-300 max-w-xl text-lg">
            Here are some of the personal projects I've worked on. Each one presented unique challenges and 
          ...
          {projects.map((project) => (
            ...
            >
              <div className="h-48 relative overflow-hidden bg-gray-900">
                ...
                <div className="w-full h-full bg-gradient-to-br from-secondary to-gray-800 flex items-center justify-center text-primary text-5xl font-bold">
                  {project.title[0]}
                </div>
              ...
              <div className="p-6">
                ...
                <p className="text-white opacity-80 mb-4">{project.description}</p>
